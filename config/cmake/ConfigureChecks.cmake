...
if (APPLE)
  ...
  if (ARCH_LENGTH GREATER 1)
    ...
    message(FATAL_ERROR "Building Universal Binaries on OS X is NOT supported by the LZF project. This is"
    "due to technical reasons. The best approach would be build each architecture in separate directories"
    "and use the 'lipo' tool to combine them into a single executable or library. The 'CMAKE_OSX_ARCHITECTURES'"
    "variable has been set to a blank value which will build the default architecture for this system.")
  endif ()
  set (LZF_AC_APPLE_UNIVERSAL_BUILD 0)
endif ()
...
MACRO (LZF_FUNCTION_TEST OTHER_TEST)
  if ("${OTHER_TEST}" MATCHES "^${OTHER_TEST}$")
    ...
    foreach (def ${LZF_EXTRA_TEST_DEFINITIONS})
...
LZF_FUNCTION_TEST (STDC_HEADERS)
...
if (NOT WINDOWS OR MINGW)
  ...
  #-----------------------------------------------------------------------------
  LZF_FUNCTION_TEST (HAVE_OFF64_T)
  if (HAVE_OFF64_T)
  ...
  LZF_FUNCTION_TEST (HAVE_STAT64_STRUCT)
  ...
  #-----------------------------------------------------------------------------
  LZF_FUNCTION_TEST (DEV_T_IS_SCALAR)

  # ----------------------------------------------------------------------
  # Does the struct stat have the st_blocks field?  This field is not Posix.
  #
  LZF_FUNCTION_TEST (HAVE_STAT_ST_BLOCKS)
...
if (NOT WINDOWS)
  if (HAVE_VSNPRINTF)
    LZF_FUNCTION_TEST (VSNPRINTF_WORKS)
  endif ()
  foreach (test
      HAVE_ATTRIBUTE
      HAVE_C99_FUNC
